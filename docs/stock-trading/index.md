...
1. [Usage](./usage.md) — brokers, order types, market mechanics
2. [Tutorial](./tutorial.md) — Level 1 (open an account) → Level 5 (systematic strategies); includes the **full-time worker plan**
3. [Examples](./examples.md) — concrete worked trade setups
4. [Best Practices](./best-practices.md) — risk, taxes, psychology, journaling
5. [Learning](./learning.md) — books, channels, real research
