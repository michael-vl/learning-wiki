...
1. [Usage](./usage.md) — notation software, DAWs, hardware, practice setup
2. [Tutorial](./tutorial.md) — Level 1 (theory grounded in piano) → Level 5 (composing complete pieces)
3. [Examples](./examples.md) — chord progressions, melodic patterns, song structures
4. [Best Practices](./best-practices.md) — practice habits, songwriting habits, recording habits
5. [Learning](./learning.md) — books, channels, courses, communities

## Your starting point (calibration)

Based on what you've described:
- **Intermediate piano playing.** You can play with both hands, manage moderate complexity, but probably haven't internalized scales and chord shapes in *every* key.
- **Slow sight reading.** You decode notes individually rather than recognizing patterns. Common; fixable with deliberate practice.
- **Little theory knowledge.** You know notes, probably basic chord names. Maybe the term "key" but not all 12 of them with confidence.
